...
class Runtime:
    ...
    def _run_episode(self) -> None:
        ...
        while self._in_episode:
            ...
            # print(now, last_step_time, step_time, dt)
            if dt < step_time:
    ...
    def _step(self) -> None:
        ...
        self._action_history.append(action["actions"])
        for subscriber in self._subscribers:
        ...
        if self._environment.is_episode_complete() or (
            ...
            np.savetxt(f'action_history.txt', np.array(self._action_history, dtype=np.float32), fmt='%.6f')
